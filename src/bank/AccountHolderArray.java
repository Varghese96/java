...
public class AccountHolderArray extends BankArray{
    ...
    public static void main(String[] args) {
        ...
        AccountHolderArray a1=new AccountHolderArray(1076,1,"sbi",123,1000,"sam");
        AccountHolderArray a2=new AccountHolderArray(1076,1,"sbi",345,500,"Binu");
        AccountHolderArray a3=new AccountHolderArray(1078,2,"axis",789,400,"Coma");
